...
public:
    ...
    ~Shape(){
    cout<<"This is Destructor (Shape)"<<endl;
    }
...
//constructor
    ...
    Line(int x1, int y1, int x2, int y2, int col) : start(x1, y1), eNd(x2, y2), Shape(col)
    {
...
/*
    void draw()
    {
        line(draw_shape(), start.getx(), start.gety(), eNd.getx(), eNd.gety());
    }
*/
...
//constructor
    ...
    Rect(int x1, int y1, int x2, int y2, int col) : rec(x1, y1), re(x2, y2), Shape(col)
    {
...
//constructor
    ...
    Circle(int Num1, int Num2, int rad, int col) : center(Num1, Num2), Shape(col)
    {
        radius = rad;
...
// if i use color here, will take new color
